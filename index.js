...
app.get("/books-AccessToken/", async (request, response) => {
  let jwtToken;
  ...
  if (jwtToken === undefined) {
    ...
    jwt.verify(jwtToken, "My_secret_Token", async (error, payload) => {
      if (error) {
        ...
        const GetBooksQuery = `Select * from book where ORDER BY book_id;`;
